...
import DoctorFilters from "@/components/filters/doctor-filters"
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-2">Doctors in Bangalore</h1>
        <p className="text-muted-foreground mb-8">Find and book appointments with top medical professionals</p>

        <div className="grid md:grid-cols-4 gap-6">
          <aside>
            <DoctorFilters onFilter={handleFilter} />
          </aside>
